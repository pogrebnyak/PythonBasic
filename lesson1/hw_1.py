while True:
  ...
  while True:
      ...
      if a.isdigit() == 0 :
        print('ОШИБКА! Длина А должна быть целое цисло больше нуля')
        continue
      if int(a) == 0 :
  ...
  while True:
      ...
      if b.isdigit() == 0 :
        print('ОШИБКА! Ширина B должна быть целое цисло больше нуля')
        continue
      if int(b) == 0 :
  ...
  S=int(a)*int(b)
  P=2*(int(a)+int(b))
  print("Площадь прямоугольника "+a+' мм x '+b+" мм =",S,'мм'+u"\u00b2")
  print("Периметр прямоугольника "+a+' мм x '+b+" мм =",P,'мм')
  y = input('Вычислить площадь прямоугольника еще раз (y/n)? ')
  if y != 'y' : break
